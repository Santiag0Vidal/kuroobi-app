...
const whatsappMessage =
  "Hola, vengo de la web. Me gustaría reservar una evaluación en Kuroobi Lab o recibir más información.";
// IMÁGENES
const imgIdentity =
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl space-y-8">
          ...
          >
            <h2 className="text-xl md:text-3xl font-light tracking-[0.3em] uppercase text-amber-400 mb-6">
              ...
              <span className="font-bold text-white">se puede mejorar</span>
            </h2>
          ...
          >
            <span>Fútbol</span> • <span>Running</span> • <span>Ciclismo</span> •{" "}
            <span>Tenis</span> • <span>Básquet</span> • <span>Golf</span>
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          <div className="inline-block border-l-4 border-red-600 pl-4">
            <h3 className="text-amber-400 font-bold tracking-widest text-sm uppercase mb-2">
              Identidad
            </h3>
          ...
          <p className="text-gray-400 text-lg leading-relaxed font-light">
            En <strong>Kuro Obi Lab</strong> fusionamos datos científicos con la
            práctica deportiva real. Nacimos para acompañar al{" "}
            <span className="text-white font-medium">deportista neuquino</span>{" "}
            en su camino hacia la excelencia.
          </p>
          <p className="text-gray-400 text-lg leading-relaxed font-light">
            No somos solo un gimnasio, somos un centro de bio-ingeniería donde
            decodificamos tu movimiento para potenciar tu rendimiento y blindar
            tu cuerpo contra lesiones.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Un proceso metódico diseñado para transformar datos en resultados
              tangibles.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <h4 className="text-sm text-amber-400 font-bold uppercase tracking-wider mb-4">
                  {step.subtitle}
                </h4>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                Aplicaciones de la{" "}
                <span className="text-red-600">Plataforma</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 mt-4">
              Nuestras herramientas y los casos que tratamos con éxito.
            </p>
          </div>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-[#111] p-8 md:p-10 rounded-3xl border-l-4 border-amber-400 shadow-2xl group hover:bg-[#161616] transition-colors"
            >
            ...
            <motion.div
              variants={itemVariants}
              className="bg-[#111] p-8 md:p-10 rounded-3xl border-r-4 border-red-600 shadow-2xl group hover:bg-[#161616] transition-colors text-right md:text-left"
            >
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
                {lesiones.map((lesion, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 text-gray-300 text-sm justify-end md:justify-start"
                  >
                    <Crosshair className="w-1.5 h-1.5 text-red-600 flex-shrink-0 order-2 md:order-1" />{" "}
                    {/* Icono cambia de lado en móvil según alineación */}
      ...
      <section className="py-20 px-6 bg-gradient-to-t from-green-900/10 to-transparent border-t border-white/5 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-xl text-gray-300 font-light max-w-2xl mx-auto">
            Agenda tu evaluación hoy. Descubre tus métricas, corrige asimetrías
            y lleva tu rendimiento al siguiente nivel.
          </p>

          <div className="pt-8">
            <a
              // 👇 AQUÍ ESTÁ EL CAMBIO: Agregamos el texto codificado
            ...
            >
              {/* ... (el SVG y el texto siguen igual) ... */}
